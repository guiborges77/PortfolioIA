      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="space-y-8 animate-fade-in-up">
          ...
          <div className="space-y-4">
            <h1 className="text-6xl font-black mt-32 mb-16 md:text-8xl md:mt-0 md:mb-6 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-gradient-x">
              {t("hero.title")}
            </h1>
